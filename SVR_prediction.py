...
if __name__ == '__main__':
    ...
    file_path = r'D:\Users\yyh\Pycharm_workspace\CNN_response_simulation\data\KNN_prediction_error.csv'
    ...
    for select_loop in range(21):
        ...
        for pred_interval in range(1, 5):
            ...
            # 预测方式为根据加权距离的KNR
            mape, mae = mean_absolute_percentage_error(ss_y.inverse_transform(y_test), ss_y.inverse_transform(dis_knr_y_predict))
            result.append(mape)
            result.append(mae)
